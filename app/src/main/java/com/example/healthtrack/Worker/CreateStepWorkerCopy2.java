...
public class CreateStepWorkerCopy2 extends Worker {

    private StepController stepController;
    private Context context;

    public CreateStepWorkerCopy2(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public static void createStepWorkerCopy2(Context context) {
        Constraints constraints = new Constraints.Builder()
                .setRequiredNetworkType(NetworkType.CONNECTED)
                .build();

        PeriodicWorkRequest.Builder dailyWorkBuilder =
                new PeriodicWorkRequest.Builder(CreateStepWorkerCopy2.class, 24, TimeUnit.HOURS)
