...
public class CreateStepWorkerCopy extends Worker {

    private StepController stepController;
    private Context context;

    public CreateStepWorkerCopy(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public static void createStepWorkerCopy(Context context) {
        Constraints constraints = new Constraints.Builder()
                .setRequiredNetworkType(NetworkType.CONNECTED)
                .build();

        PeriodicWorkRequest.Builder dailyWorkBuilder =
                new PeriodicWorkRequest.Builder(CreateStepWorkerCopy.class, 24, TimeUnit.HOURS)
